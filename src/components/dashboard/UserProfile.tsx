...
export function UserProfile() {
  const [activeTab, setActiveTab] = useState<'profile' | 'settings' | 'subscription' | 'achievements'>('profile');
  ...
  const userProfile = {
    ...
    avatar: '👨‍💻',
    joinDate: 'March 2022',
    skills: ['Machine Learning', 'Python', 'TensorFlow', 'PyTorch', 'Computer Vision', 'NLP', 'AWS', 'Docker'],
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-blue-600 rounded-xl p-6 text-white">
        ...
        <p className="text-white/90">Manage your account, preferences, and subscription details.</p>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {userProfile.interests.map((interest) => (
                    <span key={interest} className="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm font-medium">
                      {interest}
                    </span>
                  ))}
                </div>
              ...
              <div className="bg-gradient-to-r from-yellow-400 to-blue-600 rounded-xl p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-white/90 mb-2">Status: {subscription.status}</p>
                    <p className="text-white/90">Next billing: {subscription.nextBilling}</p>
                  </div>
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        <td className="px-6 py-4 text-sm text-gray-900">March 15, 2024</td>
                        <td className="px-6 py-4 text-sm text-gray-900">₹2,999</td>
                      ...
                      <tr>
                        <td className="px-6 py-4 text-sm text-gray-900">February 15, 2024</td>
                        <td className="px-6 py-4 text-sm text-gray-900">₹2,999</td>
                        <td className="px-6 py-4">
                          <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">Paid</span>
                        </td>
