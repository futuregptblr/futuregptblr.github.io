...
export default function AdminPage() {
  ...
  useEffect(() => {
    setEventDraft(managingEvent ? { ...managingEvent } : null);
  }, [managingEvent]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <form onSubmit={async (e) => {
              ...
              const payload: any = {
                ...
                lumaUrl: eventForm.lumaUrl || undefined,
                meetupUrl: eventForm.meetupUrl || undefined,
              ...
              setEventForm({ title: '', description: '', date: '', startTime: '', endTime: '', location: '', locationUrl: '', chapter: '', type: 'Meetup', capacity: 0, file: null, lumaUrl: '', meetupUrl: '' });
              setLoading(false);
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Luma Registration URL</label>
                    <input
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      value={eventForm.lumaUrl}
                      onChange={e => setEventForm(f => ({ ...f, lumaUrl: e.target.value }))}
                      placeholder="https://lu.ma/your-event"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Meetup Registration URL</label>
                    <input
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      value={eventForm.meetupUrl}
                      onChange={e => setEventForm(f => ({ ...f, meetupUrl: e.target.value }))}
      ...
      {/* Manage Event Modal */}
      {managingEvent !== null && eventDraft !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-2xl font-bold text-gray-900">Manage Event</h2>
              <button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={e => setEventDraft((draft: any) => ({ ...draft, title: e.target.value }))}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Description</label>
                  <textarea
                    ...
                    onChange={e => setEventDraft((draft: any) => ({ ...draft, description: e.target.value }))}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Date</label>
                  <input
                    ...
                    onChange={e => setEventDraft((draft: any) => ({ ...draft, date: e.target.value }))}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Chapter</label>
                  <input
                    ...
                    onChange={e => setEventDraft((draft: any) => ({ ...draft, chapter: e.target.value }))}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Location</label>
                  <input
                    ...
                    onChange={e => setEventDraft((draft: any) => ({ ...draft, location: e.target.value }))}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Capacity</label>
                  <input
                    ...
                    onChange={e => setEventDraft((draft: any) => ({ ...draft, capacity: Number(e.target.value) }))}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Luma URL</label>
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    value={eventDraft.lumaUrl || ''}
                    onChange={e => setEventDraft((draft: any) => ({ ...draft, lumaUrl: e.target.value }))}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Meetup URL</label>
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    value={eventDraft.meetupUrl || ''}
                    onChange={e => setEventDraft((draft: any) => ({ ...draft, meetupUrl: e.target.value }))}
                  />
                </div>
              </div>
              <div className="flex gap-3 mt-6 pt-6 border-t border-gray-200">
