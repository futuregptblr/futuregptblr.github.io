...
export function JobDetailPage() {
    ...
    try {
      ...
      if (token) {
        ...
        if (response.ok) {
          ...
          const hasAppliedToThisJob = applications.some((app: any) => {
            const jid = app?.jobId;
            const appJobId =
              typeof jid === "string" ? jid : jid?._id || jid?.id;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
      ...
      <div className="flex items-center space-x-4 mt-2 text-gray-600 mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <button
              onClick={() => {
                const rawCompanyId = job.companyId as unknown as any;
                const resolvedCompanyId =
                  typeof rawCompanyId === "string"
                    ? rawCompanyId
                    : rawCompanyId?._id || rawCompanyId?.$oid || "";
                if (resolvedCompanyId) {
                  navigate(`/company/${resolvedCompanyId}`);
                }
              }}
