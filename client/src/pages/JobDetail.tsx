            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              {hasApplied ? (
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-600 mt-1">We'll review your application and get back to you soon.</p>
                </div>
              ) : (
                <button
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                {job.remotePolicy && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900 capitalize">{job.remotePolicy}</p>
                    </div>
                  </div>
                )}
                ...
                {job.startDate && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{new Date(job.startDate).toLocaleDateString()}</p>
                    </div>
                  </div>
                )}
                ...
                {job.contractDuration && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{job.contractDuration}</p>
                    </div>
                  </div>
                )}
              ...
              {(job.visaSponsorship || job.relocationAssistance) && (
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <h4 className="text-sm font-medium text-gray-900 mb-3">Additional Perks</h4>
                  <div className="space-y-2">
                    ...
                    {job.relocationAssistance && (
                      <div className="flex items-center space-x-2">
                        <CheckCircle className="h-4 w-4 text-green-500" />
                        <span className="text-sm text-gray-700">Relocation Assistance</span>
                      </div>
                    )}
                  </div>
                </div>
